...
//print_r($_POST);exit();
 ...
 require_once "recaptchalib.php";
   ...
   // your secret key
   $secret = "6LeW48khAAAAACUpKFiGJEkwSPraVLzMf9hlT-kF";
...
if($error=="")
{
    ...
    require 'PHPMailer/PHPMailerAutoload.php';
       ...
       $mail->Username = 'enquiryformnetcom@gmail.com';                 // SMTP username
  $mail->Password = 'wtglpiuuhfqjgfdu';                           // SMTP password
        $mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 465;                                    // TCP port to connect to
      //  $mail->Port = 587;                                    // TCP port to connect to

        $mail->From = 'bioclixchemicals@gmail.com';
        $mail->FromName ='bioclixchemicals@gmail.com';
        $mail->addAddress('bioclixchemicals@gmail.com'); 
       ...
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Bioclix Chemicals & Pharmaceuticals';
        $mail->isHTML(true);
